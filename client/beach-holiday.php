  ...
  <section class="py-5 text-center container">
    <div class="row py-lg-5">
      <div class="col-lg-6 col-md-8 mx-auto">
        <h1 class="fw-light">Beach Holiday Packages</h1>
        <p class="lead text-muted">Check out some great Beach holiday packages tailor made just for you. There are numerous options for you this includes an exclusive tour
          that is aimed at travellers that are looking for an extra bit of comfort - you choose.</p>
      </div>
    </div>
  </section>
