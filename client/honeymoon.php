  ...
  <section class="py-5 text-center container">
    <div class="row py-lg-5">
      <div class="col-lg-6 col-md-8 mx-auto">
        <h1 class="fw-light">Honeymoon Packages</h1>
        <p class="lead text-muted">Wondering where to go on your honeymoon? We've got you covered. We have exclusive honeymoon packages that you can choose from.
            Best price guaranteed for the best Kenyan honeymoon destinations.</p>
      </div>
    </div>
  </section>
